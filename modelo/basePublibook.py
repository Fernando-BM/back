...
class Publicacion(Base):
    ...
    idPublicacion = Column(INTEGER(11), primary_key=True, nullable=False)
    ...
    idTipo = Column(INTEGER(11), nullable=False)
    idSolicitud = Column(ForeignKey('publibook2.0.Cat_tipo.idTipo', ondelete='CASCADE', onupdate='CASCADE'), primary_key=True, nullable=False, index=True)

    Cat_tipo = relationship('CatTipo')


class SolicitudPublicacion(Publicacion):
    __tablename__ = 'Solicitud_publicacion'
    __table_args__ = {'schema': 'publibook2.0'}

    idSolicitud = Column(ForeignKey('publibook2.0.Publicacion.idSolicitud', ondelete='CASCADE', onupdate='CASCADE'), primary_key=True)
    nombre_publicacion = Column(String(45), nullable=False)
    ...
    tel_autor = Column(INTEGER(11))
    tel_editor = Column(INTEGER(11))
